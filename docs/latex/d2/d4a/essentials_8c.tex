...
\#define \mbox{\hyperlink{essentials_8c_a66980ae5fda680230944e831c7fd0eb4}{bjump}}(\+\_\+\+\_\+\+LABEL\+\_\+\+\_\+)
\begin{DoxyCompactList}\small\item\em Junp to System routine. \end{DoxyCompactList}\item 
...
Machine code to swap af and shadow af and only takes 4 t-\/states, {\bfseries{only use in asm}} ~\newline
...
Preforms a \href{https://wikiti.brandonw.net/index.php?title=83Plus:OS:How_BCALLs_work}{\texttt{ bcall}} while in C. {\bfseries{ And keep in mind that a bcall might modify registers, meaning that any bcall can corrupt any C variable }} For most bcall values click \href{https://wikiti.brandonw.net/index.php?title=Category:83Plus:BCALLs:By_Name}{\texttt{ here}}, or see \href{https://ia600606.us.archive.org/16/items/83psdk/83psysroutines.pdf}{\texttt{ TI\textquotesingle{}s system routines document}} \Hypertarget{essentials_8c_a66980ae5fda680230944e831c7fd0eb4}\label{essentials_8c_a66980ae5fda680230944e831c7fd0eb4} 
\index{essentials.c@{essentials.c}!bjump@{bjump}}
\index{bjump@{bjump}!essentials.c@{essentials.c}}
\doxysubsubsection{\texorpdfstring{bjump}{bjump}}
{\footnotesize\ttfamily \#define bjump(\begin{DoxyParamCaption}\item[{}]{\+\_\+\+\_\+\+LABEL\+\_\+\+\_\+ }\end{DoxyParamCaption})}

{\bfseries Value\+:}
\begin{DoxyCode}{0}
\DoxyCodeLine{\ \ \ \ \_\_asm\ call\ 0x50\ \(\backslash\)}
\DoxyCodeLine{\ \ \ \ .dw\ \_\_LABEL\_\_\ \_\_endasm}
...
Like a \doxylink{essentials_8c_a68264b1743db602f8233757550b88f09}{bcall()} but jumps instead of calls \Hypertarget{essentials_8c_a00779d8b864708d1f7091c47e1e87c64}\label{essentials_8c_a00779d8b864708d1f7091c47e1e87c64} 
