...
;--------------------------------------------------------
	.area _CODE
;../../lib/essentials.c:17: char getKeyId(){
;	---------------------------------
; Function getKeyId
; ---------------------------------
_getKeyId::
;../../lib/essentials.c:18: bcall(0x4015);
	rst	40 
	.dw 0x4015 
;../../lib/essentials.c:19: return *(char*)(0x843F);
	ld	hl, #0x843f
	ld	l, (hl)
;../../lib/essentials.c:20: }
	ret
;../../lib/textio.c:6: void setPenRow(char row) __naked{
;	---------------------------------
; Function setPenRow
; ---------------------------------
_setPenRow::
;../../lib/textio.c:18: __endasm;
	pop	hl ; Get input
	pop	bc ; and perserve
	push	bc
	push	hl ; ret value
	...
	ret
;../../lib/textio.c:19: }
;../../lib/textio.c:20: void setPenCol(char col) __naked{
;	---------------------------------
; Function setPenCol
; ---------------------------------
_setPenCol::
;../../lib/textio.c:32: __endasm;
	...
	ret
;../../lib/textio.c:33: }
;../../lib/textio.c:34: void resetPen() __naked{
;	---------------------------------
; Function resetPen
; ---------------------------------
_resetPen::
;../../lib/textio.c:41: __endasm;
	ld	a, #0x00
	ld	(#0x86D7), a
	ld	(#0x86D8), a
	ret
;../../lib/textio.c:42: }
;../../lib/textio.c:44: void fputs(char* loc) __naked {
;	---------------------------------
; Function fputs
; ---------------------------------
_fputs::
...
;../../lib/textio.c:62: }
;../../lib/textio.c:64: void println(char* loc){
;	---------------------------------
; Function println
; ---------------------------------
_println::
	...
	ld	ix,#0
	add	ix,sp
;../../lib/textio.c:65: fputs(loc);
	ld	l, 4 (ix)
	ld	h, 5 (ix)
	push	hl
	call	_fputs
	pop	af
;../../lib/textio.c:74: __endasm;
	ld	a, (#0x86D8)
	ld	b, #6
	add	b
	ld	(#0x86D8), a
...
;../../lib/textio.c:75: }
	pop	ix
	ret
;../../lib/textio.c:76: void newline() __naked{
;	---------------------------------
; Function newline
; ---------------------------------
_newline::
;../../lib/textio.c:86: __endasm;
	...
	ret
;../../lib/textio.c:87: }
;../../lib/textio.c:88: void printc(char ch) __naked{
;	---------------------------------
; Function printc
; ---------------------------------
_printc::
