...
#define _newContext		 0x4030 //(kbdKey)=0, loads context, restores page in 4000h-0x7fff 
...
#define _PIDIV2			 0x4243 //not code, but a pointer to:	.db 80h,15h,70h,79h,63h,26h,79h,48h,0x97 
#define _PIDIV4			 0x4246 //				.db 7fh,78h,53h,98h,16h,33h,97h,44h,0x83 
...
#define _IS_A_LSTorCLST		 0x42BE //checks if a = 1 or 0x0D 
#define _CHK_HL_999		 0x42C1 //returns nc if less than 999, throws invalid dim error if greater than or al to 999
#define __or_new		 0x42C4 
...
#define _MenuSwitchContext	 0x45E2 //switches to context in A, calls menu hook with A=3, set 5,(iy+16h) for some sort of override to not make swit0xc 
...
#define _finsDisp		 0x4768 //Michael says _FinsDisp02  0x4768 (something's not right)
...
#define _ParseInpLastEnt	 0x4B07 //ParseInp on program 05h,23h,0x00 
...
#define _CKENDEXP		 0x4B3A //checks A for 0x3E or 0x3F 
...
// #define 0x52E1 //bit 4,(9C75h) (this is DEFINITELY returning the status of something when acting as a TI-SmartView Input Pad...this bit is bit 1 of the data byte from a PC HID Set Report rest)
...
#define _RecycleUSB		 0x5311 //identical to 0x5257 
...
#define _ReceiveCalcID			 0x8081 //receives certificate replacement (including calculator ID, fails if already exists) and writes it, rires Flash unlocked
...
#define _FindProgramLicense		 0x8096 //copies 0x8010 field to appID and other insane stuff that makes zero sense
...
#define _AttemptUSBOSReceive		 0x80E4 //Z to wait for USB cable insert & get OS, NZ and A= contents of port 0x4D or 56h, ON to cancel & clear RAM
...
#define _KillUSB			 0x810E //identical to 8105h, except in the middle of the outputs, it sends zero to port 0x4C 
...
// #define penCol left edge?	 0x817B 
...
#define baseAppBrTab		 0x8230 //table of base pages for apps on page < 0x20 (starts with eight zeroes because they're OS pages)
...
// #define something		 0x837B //18 bytes, probably indicates something about Flash app pages, start out as 0x0FF 
#define appID			 0x838D 
...
#define CatalogCurrent		 0x85DA //word at this location starting with 0x6007 corresponds to what is highlighted in catalog
#define menuActive		 0x85DC 
#define menuAppDepth		 0x85DD 
#define MenuCurrent		 0x85DE 
// #define 			 0x85DF //holds current submenu index
// #define 			 0x85E0 //holds currently selected item in current submenu
// #define 			 0x85E1 //holds number of submenus for this menu
// #define 			 0x85E2 //holds number of items in this submenu
// #define 			 0x85E3 //iy+appFlags backup for menu stuff
// #define 			 0x85E4 //iy+0Ch backup for menu stuff
// #define 			 0x85E5 //curGStyle backup for menu stuff
// #define 			 0x85E6 //iy+graphFlags backup for menu stuff
#define ProgCurrent		 0x85E8 
// #define something, OP1 backup?	 0x85F2 //type and name of topmost variable on menu with names
// #define something		 0x85FD 
...
// #define something		 0x8697 //app bitmap for selecting stuff from menus
// #define something		 0x86B7 //used in 0x47 and 0x74 link packets
...
// #define something		 0x8A36 //stats-related? This gets stored to (varCurrent) for some reason
...
// #define something		 0x8D0B 
// #define list-related stat vars	 0x8D0D 
#define curGStyle		 0x8D17 
#define curGY			 0x8D18 
#define curGX			 0x8D19 
#define curGY2			 0x8D1A 
#define curGX2			 0x8D1B //currently selected ation while graphing
#define freeSaveY		 0x8D1C 
#define freeSaveX		 0x8D1D 
// #define 100 bytes		 0x8D2A 
...
// #define something		 0x8E65 
// #define something		 0x8E66 
...
// #define something		 0x91D9 
// #define something		 0x91DA 
#define CurTableRow		 0x91DC 
#define CurTableCol		 0x91DD 
#define TblMin			 0x92B3 
#define TblStep			 0x92BC 
// #define something		 0x92C5 
// #define something		 0x92C6 
// #define somePlotThing1		 0x92D9 
// #define somePlotThing2		 0x92EA 
// #define somePlotThing3		 0x92FB 
#define ES			 0x9302 //bottom of the es
#define EST			 0x9305 //current height of the es
// #define something		 0x9311 //this is the pointer to a table of stuff for a BASIC menu
...
// #define something		 0x9665 //parser-related word
// #define something		 0x966C 
// #define something		 0x966D 
...
// #define something		 0x96FE //word, this is offset into list for currently-highlighted element in list editor
// #define something		 0x9700 //table entry pointer used in dialog/menu/edit buffer routines
...
// #define something		 0x970E //stats/list editor related, usually 1
// #define something		 0x970F //stats/list editor related, usually 0 (this is 0-based offset from listName1), pretty sure this is a page offset
// #define something		 0x9710 //stats/list editor related, usually 0 (this is 0-based currently-selected list)
...
// #define something		 0x979F 
// #define something		 0x97A1 
...
// #define something		 0x984A //this is the top LCD row for a menu (usually 1)
...
#define baseAppBrTab2		 0x9C06 //table of base pages for apps on page >= 20h// first 0x20 bytes are zeroes.
...
// #define something		 0x9C86 //used with SE link activity, values of 00h, 0FAh, 0x0FF probably mean something
// #define something		 0x9C87 //zero this to force the APPS menu to recache itself (this is always either 0, 1, or last app page, for some reason)
// #define something		 0x9C88 //don't know, but it's 14 bytes and has to do with selecting stuff (if 0x9C87 is non-zero, this is zeroed out)
// #define something		 0x9C9E //funky, this actually gets written to the certificate on non-83+ (11 bytes)
#define SEspeed			 0x9CAE 
// #define something, table index	 0x9CAF 
// #define something		 0x9CB0 
// #define something		 0x9CB1 //table
// #define something		 0x9CCD 
...
#define grfSimul		 1		//0=sential, 1=simultaneous
...
#define onInterrupt		 4		//1=on key interrupt rest
#define statFlags		 9	//statistics flags
// #define unknown		 5		//unknown
...
#define seqFlags		 0x0F	//Sential Graph flags
...
#define IDis95h			 1		//1 = link routines use machine ID 0x95 (CBL)
#define IDis82h			 2		//1 = link routines use machine ID 0x82 (TI-82)
#define IDis83h			 3		//1 = link routines use machine ID 0x83 (TI-83)
#define IDis03h			 4		//1 = link routines use machine ID 0x03 (PC to TI-83)
...
#define noCompletionByte	 2		//1 = do not write 0x0FC when calling Arc_Unarc, leave as 0x0FE 
...
// #define hookflags2Override	  0x37		//set corresponding bit to kill iy+35h hook when executing app
// #define hookflags3Override	  0x38		//set corresponding bit to kill iy+36h hook when executing app
// #define hookflags4Override	  0x39		//set corresponding bit to kill iy+37h hook when executing app
// #define hookflags5		 0x3A 
...
#define kY			 0x049 //EQUATION EDITOR
...
#define cxEquEdit		 kY //ation editor
...
#define EOSSTART		 0
#define DCONV			 0x01 
#define tToDMS			 DCONV //0x01 
#define tToDEC			 DCONV+1 //0x02 
...
#define tEvalF			 IMUN+20 //0x26 
#define tFmin			 IMUN+21 //0x27 
#define tFmax			 IMUN+22 //0x28 
...
#define NUMS			 0x30 
#define t0			 NUMS //0x30 
#define t1			 NUMS+1 //0x31 
#define t2			 NUMS+2 //0x32 
#define t3			 NUMS+3 //0x33 
#define t4			 NUMS+4 //0x34 
#define t5			 NUMS+5 //0x35 
#define t6			 NUMS+6 //0x36 
#define t7			 NUMS+7 //0x37 
#define t8			 NUMS+8 //0x38 
#define t9			 NUMS+9 //0x39 
#define tDecPt			 NUMS+10 //0x3A 
#define tee			 NUMS+11 //0x3B 
#define tOr			 0x3C //3Ch '_or_'
#define tXor			 0x3D //0x3D 
#define tColon			 0x3E //3Eh ':'
#define tEnter			 0x3F //3Fh Lenter
#define tAnd			 0x40 //40h '_and_'
#define LET			 0x41 
#define tA			 LET //0x41 
#define tB			 LET+1 //0x42 
#define tC			 LET+2 //0x43 
#define tD			 LET+3 //0x44 
#define tE			 LET+4 //0x45 
#define tF			 LET+5 //0x46 
#define tG			 LET+6 //0x47 
#define tH			 LET+7 //0x48 
#define tI			 LET+8 //0x49 
#define tJ			 LET+9 //0x4A 
#define tK			 LET+10 //0x4B 
#define tL			 LET+11 //0x4C 
#define tM			 LET+12 //0x4D 
#define tN			 LET+13 //0x4E 
#define tO			 LET+14 //0x4F 
#define tP			 LET+15 //0x50 
#define tQ			 LET+16 //0x51 
#define tR			 LET+17 //0x52 
#define tS			 LET+18 //0x53 
#define tT			 LET+19 //0x54 
#define tU			 LET+20 //0x55 
#define tV			 LET+21 //0x56 
#define tW			 LET+22 //0x57 
#define tX			 LET+23 //0x58 
#define tY			 LET+24 //0x59 
#define tZ			 LET+25 //0x5A 
#define tTheta			 LET+26 //0x5B 
#define vToks			 LET+27
#define tVarMat			 vToks //0x5C 
#define tVarLst			 vToks+1 //0x5D 
#define tVarEqu			 vToks+2 //0x5E 
#define tProg			 vToks+3 //0x5F 
#define tVarPict		 vToks+4 //0x60 
#define tVarGDB			 vToks+5 //0x61 
#define tVarOut			 vToks+6 //0x62 
#define tVarSys			 vToks+7 //0x63 
#define MODESA			 vToks+8 //0x64 
...
#define GRCMDS			 0x84 
#define tTrace			 GRCMDS // 0x84 'Trace'
#define tClDrw			 GRCMDS+1 // 0x85 'ClDrw'
#define tZoomStd		 GRCMDS+2 // 0x86 'ZStd'
#define tZoomtrg		 GRCMDS+3 // 0x87 'Ztrg'
#define tZoomBox		 GRCMDS+4 // 0x88 'ZBOX'
#define tZoomIn			 GRCMDS+5 // 0x89 'ZIn'
#define tZoomOut		 GRCMDS+6 // 0x8A 'ZOut'
#define tZoomSqr		 GRCMDS+7 // 0x8B 'ZSqr'
#define tZoomInt		 GRCMDS+8 // 0x8C 'ZInt'
#define tZoomPrev		 GRCMDS+9 // 0x8D 'ZPrev'
#define tZoomDec		 GRCMDS+10 // 0x8E 'ZDecm'
#define tZoomStat		 GRCMDS+11 // 0x8F 'ZStat
#define tUsrZm			 GRCMDS+12 // 0x90 'ZRcl'
#define tPrtScrn		 GRCMDS+13 // 0x91 'PrtScrn'
#define tZoomSto		 GRCMDS+14 // 0x92  ZOOM STORE
#define tText			 GRCMDS+15 // 0x93 
...
#define tPXOn			 GRCMDS+29 //0xA1 
#define tPXOff			 GRCMDS+30 //0xA2 
#define tPXChg			 GRCMDS+31 //0xA3 
...
#define UNARY			 tQuest+1 //0xB0 
#define tChs			 UNARY //0xB0 
#define tInt			 UNARY+1 //0xB1 
#define tAbs			 UNARY+2 //0xB2 
#define tDet			 UNARY+3 //0xB3 
#define tIdent			 UNARY+4 //0xB4 
#define tDim			 UNARY+5 //0xB5 
#define tSum			 UNARY+6 //0xB6 
#define tProd			 UNARY+7 //0xB7 
#define tNot			 UNARY+8 //0xB8 
#define tIPart			 UNARY+9 //0xB9 
#define tFPart			 UNARY+10 //0xBA 
#define t2ByteTok		 0x0BB 
#define UNARYLR			 UNARY+12
#define tSqrt			 UNARYLR //0xBC 
#define tCubRt			 UNARYLR+1 //0xBD 
#define tLn			 UNARYLR+2 //0xBE 
#define tExp			 UNARYLR+3 //0xBF 
#define tLog			 UNARYLR+4 //0xC0 
#define tALog			 UNARYLR+5 //0xC1 
#define tSin			 UNARYLR+6 //0xC2 
#define tASin			 UNARYLR+7 //0xC3 
#define tCos			 UNARYLR+8 //0xC4 
#define tACos			 UNARYLR+9 //0xC5 
#define tTan			 UNARYLR+10 //0xC6 
#define tATan			 UNARYLR+11 //0xC7 
#define tSinH			 UNARYLR+12 //0xC8 
#define tASinH			 UNARYLR+13 //0xC9 
#define tCoshH			 UNARYLR+14 //0xCA 
#define tACosH			 UNARYLR+15 //0xCB 
#define tTanH			 UNARYLR+16 //0xCC 
#define tATanH			 UNARYLR+17 //0xCD 
#define PROGTOK			 UNARYLR+18
#define tIf			 PROGTOK //0xCE 
#define tThen			 PROGTOK+1 //0xCF 
#define tElse			 PROGTOK+2 //0xD0 
#define tWhile			 PROGTOK+3 //0xD1 
#define tRepeat			 PROGTOK+4 //0xD2 
#define tFor			 PROGTOK+5 //0xD3 
#define tEnd			 PROGTOK+6 //0xD4 
#define tReturn			 PROGTOK+7 //0xD5 
...
#define tMedMed			 STATCMD+6 //0xF8 
#define tQuad			 STATCMD+7 //0xF9 
